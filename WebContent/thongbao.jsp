...
<title>Thông báo thay đổi</title>
...
<%if(action.equals("quenmk")){ %>
	<center><h2 style="color: #BDBDBD">Mật khẩu của bạn đã được gửi về mail. Mời bạn vào mail để kiểm tra ! <span class="glyphicon glyphicon-alert"></span></h2></center>
<%} if(action.equals("xuatdonhang")){%>
	<center><h2 style="color: #BDBDBD">Bạn đã xuất đơn hàng thành công. Chúng tôi sẽ liên hệ với bạn. Bạn có thể check mail để xem chi tiết! <span class="glyphicon glyphicon-alert"></span></h2></center>
<%}else{ %>
	<center><h2 style="color: #BDBDBD">Mật khẩu của bạn đã được thay đổi thành công <span class="glyphicon glyphicon-alert"></span></h2></center>
<%} %>
<center><a href="index.jsp"><h1>Về trang chủ</h1></a></center>
