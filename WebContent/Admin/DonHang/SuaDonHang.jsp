...
<%		ServletContext contextDangNhap=getServletContext();
					contextDangNhap.setAttribute("urlweb","Admin/DonHang/SuaDonHang.jsp");
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2> <small>Trong một số trường hợp đơn hàng khách hàng không đúng,hoặc lí do nào đó khách hàng muốn sửa đổi nên mình cần phải sửa đổi lại cho phù hợp với yêu cầu <br>từ khách hàng</small></h2>
                  ...
                  <div class="x_content">
                    ...
                    <%Map<String,DonHang> mapOrder = DonHangDAO.mapOrder;
                    	...
                    	for(DonHang od : mapOrder.values()){
                    		if(od.getMaDonHang().equals(id)){
                    			dh=od;
                    		}
                    	}
                    	if(dh!=null){
                    %>
                    <form id="editorder" data-parsley-validate class="form-horizontal form-label-left"  action="../../Order?action=Edit&id=<%=dh.getMaDonHang() %>" method="post">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="row">
                               <div class="col-sm-8">
                                <input type="date" id="ngayDatHang" name="date" class="form-control col-md-7 col-xs-12" value="<%out.print(dh.getNgayGui());%>">
                               </div>
                               <div class="col-sm-2">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <div class="row">
                               <div class="col-sm-8">
                                 <input type="text" id="name" name="name" class="form-control col-md-7 col-xs-12" value="<%out.print(dh.getTenKhachHang());%>">
                               </div>
                               <div class="col-sm-2">
                                <p id="icon-name"></p>
                               </div>
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Trạng thái giao hàng <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <div class="row">
                               <div class="col-sm-8">
                                 <input type="text" id="status" name="status" class="form-control col-md-7 col-xs-12" value="<%out.print(dh.getTrangThai());%>">
                               </div>
                               <div class="col-sm-2">
                                <p id="icon-status"></p>
                               </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                           <div class="row">
                               <div class="col-sm-8">
                                 <input type="text" id="productName" name="tenSP" class="form-control col-md-7 col-xs-12" value="<%out.print(dh.getTenSanPham());%>">
                               </div>
                               <div class="col-sm-2">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <div class="row">
                               <div class="col-sm-8">
                                 <input type="number" id="price" name="count" class="form-control col-md-7 col-xs-12" value="<%out.print(dh.getTongSoTien());%>">
                               </div>
                               <div class="col-sm-2">
                                <p id="icon-price"></p>
                               </div>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <div class="row">
                               <div class="col-sm-8">
                                 <input id="phone" class=" form-control col-md-7 col-xs-12" type="number" name="sdt" value="<%out.print(dh.getSdt());%>">
                               </div>
                               <div class="col-sm-2">
                                <p id="icon-phone"></p>
                               </div>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <div class="row">
                               <div class="col-sm-8">
                                 <input id="address" class=" form-control col-md-7 col-xs-12" type="text" name="address" value="<%out.print(dh.getDiaChi());%>">
                               </div>
                               <div class="col-sm-2">
                                <p id="icon-address"></p>
                               </div>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <div class="row">
                               <div class="col-sm-8">
                                  <input id="info" class=" form-control col-md-7 col-xs-12" type="text" name="mota" value="<%out.print(dh.getMoTa());%>">
                               </div>
                               <div class="col-sm-2">
                                <p id="icon-info"></p>
                               </div>
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          <button type="submit" class="btn btn-sm btn-success"><span class="glyphicon glyphicon-edit"></span>  Sửa đơn hàng</button>
                        </div>
                      </div>
