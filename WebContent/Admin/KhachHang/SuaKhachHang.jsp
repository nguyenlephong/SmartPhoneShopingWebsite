...
<%		ServletContext contextDangNhap=getServletContext();
					contextDangNhap.setAttribute("urlweb","Admin/KhachHang/SuaKhachHang.jsp");
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2> <small>Trong một số trường hợp bạn cần phải thay đổi tài khoản của mình hoặc quản lí tài khoản của khách hàng thì chúng ta cần sửa lại cho khách hàng.</small></h2>
                  ...
                  <div class="x_content">
                    ...
                    <form id="editcustomer" data-parsley-validate class="form-horizontal form-label-left"  action="../../KhachHang?action=Edit&id=<%=kh.getId() %>" method="post">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                             <div class="row">
                               <div class="col-sm-8">
                                 <input type="text" id="acountName"   name="username" class="form-control col-md-7 col-xs-12"  value="<%out.print(kh.getUser());%>">
                               </div>
                               <div class="col-sm-2">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <div class="row">
                               <div class="col-sm-8">
                                 <input type="password" id="pass"   name="password" class="form-control col-md-7 col-xs-12" value="<%out.print(kh.getPass());%> ">
                               </div>
                               <div class="col-sm-2">
                                <p id="icon-pass"></p>
                               </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <div class="row">
                               <div class="col-sm-8">
                                <input type="text" id="name"   name="name" class="form-control col-md-7 col-xs-12" value="<%out.print(kh.getName());%>">
                               </div>
                               <div class="col-sm-2">
                                <p id="icon-name"></p>
                               </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <div class="row">
                               <div class="col-sm-8">
                                    <input type="email" id="email" name="email" class="form-control col-md-7 col-xs-12" value="<%out.print(kh.getEmail());%>">
                               </div>
                               <div class="col-sm-2">
                                <p id="icon-email"></p>
                               </div>
                         ...
                         <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Địa chỉ khách hàng <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <div class="row">
                               <div class="col-sm-8">
                                 <input id="address" class=" form-control col-md-7 col-xs-12"   type="text" name="address" value="<% out.print(kh.getAddress());%>">
                               </div>
                               <div class="col-sm-2">
                                <p id="icon-address"></p>
                               </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <div class="row">
                               <div class="col-sm-8">
                                 <input type="number" id="phone" name="phone"   class="form-control col-md-7 col-xs-12" value="<% out.print(kh.getPhone());%>">
                               </div>
                               <div class="col-sm-2">
                                <p id="icon-phone"></p>
                               </div>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <div class="row">
                               <div class="col-sm-8">
                                 <input type="text" id="card" name="stk"   class="form-control col-md-7 col-xs-12" value="<% out.print(kh.getStk());%>">
                               </div>
                               <div class="col-sm-2">
                                <p id="icon-card"></p>
                               </div>
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          ...
                          <button type="submit" class="btn btn-sm btn-success"><span class="glyphicon glyphicon-edit"></span>  Sửa</button>
                        </div>
                      </div>
