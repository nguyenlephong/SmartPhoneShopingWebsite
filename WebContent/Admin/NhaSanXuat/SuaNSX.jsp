...
<%		ServletContext contextDangNhap=getServletContext();
					contextDangNhap.setAttribute("urlweb","Admin/NhaSanXuat/SuaNSX.jsp");
...
<%@page import="admin.dao.*"%>
    ...
    for(NhaSanXuat n : mapProducer.values()){
    	if(n.getMaNSX().equals(maNSX)){
    		nsx=n;
    	}
    }
    %>
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2> <small>Chỉnh sửa thông tin nhà sản xuất</small></h2>
                  ...
                  <div class="x_content">
                    <br />
                    <%if(nsx!=null){ %>
                    <form id="editProducer" data-parsley-validate class="form-horizontal form-label-left"  action="../../Producer?action=Edit&id=<%=nsx.getMaNSX()%>" method="post">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                           <div class="row">
                               <div class="col-sm-8">
                                <input type="text" id="producerName" name="name" class="form-control col-md-7 col-xs-12"  value="<%out.print(nsx.getTenNSX());%>">
                               </div>
                               <div class="col-sm-2">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                           <div class="row">
                               <div class="col-sm-8">
                                 <input type="text" id="maSanPham" name="other_id" class="form-control col-md-7 col-xs-12" value="<%out.print(nsx.getMaSP());%>">
                               </div>
                               <div class="col-sm-2">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                           <div class="row">
                               <div class="col-sm-8">
                                <input type="text" id="address" name="address" class="form-control col-md-7 col-xs-12" value="<%out.print(nsx.getDiaChi());%>">
                               </div>
                               <div class="col-sm-2">
                                <p id="icon-address"></p>
                               </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <div class="row">
                               <div class="col-sm-8">
                                 <input type="text" id="phone" name="sdt" class="form-control col-md-7 col-xs-12"  value="<%out.print(nsx.getSdt());%>">
                               </div>
                               <div class="col-sm-2">
                                <p id="icon-phone"></p>
                               </div>
