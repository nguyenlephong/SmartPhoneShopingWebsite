  <%		ServletContext contextDangNhap=getServletContext();
					contextDangNhap.setAttribute("urlweb","Admin/SanPham/ThemSanPham.jsp");
    ...
    <script type="text/javascript">
  	$(document).ready(function(){
  		$('#addProduct').bind({
  			'submit':function(){
  						if($('#productID').val()==''){
  							$('#productID').css('box-shadow','0px 0px 2px 2px red');
  							$('#error-productID').html('Bạn không được bỏ trống trường này!');
  							$('#icon-productID').html('<span style="color:green" class=" glyphicon glyphicon-remove"></span>');
  							return false;
  						}
                        if($('#productName').val()==''){
  			 ...
  			 'keyup':function(){
  						if($('#productID').val().length>0){
  							$('#productID').css('box-shadow','0px 0px 1px 1px green');
  							$('#icon-productID').html('<span class="glyphicon glyphicon-ok "></span>');
  							$('#error-productID').html(' ');
  						}
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Thêm thông tin sản phẩm <small> bao gồm các thông tin sau:</small></h2>
                  ...
                  <div class="x_content">
                    <br />
                    <form id="addProduct" data-parsley-validate class="form-horizontal form-label-left" action="../../Product?action=Add" method="post">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <div class="row">
                               <div class="col-sm-8">
                                 <input type="text" id="productID" name="maSP" class="form-control col-md-7 col-xs-12" value="">
                               </div>
                               <div class="col-sm-2">
                                <p id="icon-productID"></p>
                               </div>
							</div>
							<div class="row">
							    <p style="color: red" id="error-productID"></p>	
							</div>
                        </div>
                      </div>
 						<div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <div class="row">
                               <div class="col-sm-8">
                                <input type="text" id="productName" name="ten" class="form-control col-md-7 col-xs-12" value="">
                               </div>
                               <div class="col-sm-2">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <div class="row">
                               <div class="col-sm-8">
                                  <input id="giaSanPham" class=" form-control col-md-7 col-xs-12" name="gia" value="" type="number">
                               </div>
                               <div class="col-sm-2">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <div class="row">
                               <div class="col-sm-8">
                                 <input id="congNgheManHinh" class=" form-control col-md-7 col-xs-12" name="congnghemanhinh" value="" type="text">
                               </div>
                               <div class="col-sm-2">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <div class="row">
                               <div class="col-sm-8">
                                <input id="doPhanGiai" class=" form-control col-md-7 col-xs-12" name="dophangiai" value="" type="text">
                               </div>
                               <div class="col-sm-2">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <div class="row">
                               <div class="col-sm-8">
                                <input id="doRongManHinh" class=" form-control col-md-7 col-xs-12" name="dorongmanhinh" value="" type="text">
                               </div>
                               <div class="col-sm-2">
                       ...
                       <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <div class="row">
                               <div class="col-sm-8">
                                  <input id="camUng" class=" form-control col-md-7 col-xs-12" name="camUng" value="" type="text">
                               </div>
                               <div class="col-sm-2">
                                <p id="icon-camUng"></p>
                               </div>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <div class="row">
                               <div class="col-sm-8">
                                  <input type="text" id="cameraTruoc" name="cmrt" class="form-control col-md-7 col-xs-12" value="">
                               </div>
                               <div class="col-sm-2">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <div class="row">
                               <div class="col-sm-8">
                                   <input id="CameraSau" class="form-control col-md-7 col-xs-12" type="text" name="cmrs" value="">
                               </div>
                               <div class="col-sm-2">
                       ...
                       <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <div class="row">
                               <div class="col-sm-8">
                                   <input id="denFlash" class=" form-control col-md-7 col-xs-12" name="den" value="" type="text">
                               </div>
                               <div class="col-sm-2">
                       ...
                       <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <div class="row">
                               <div class="col-sm-8">
                                    <input id="heDieuHanh" class=" form-control col-md-7 col-xs-12" name="hedieuhanh" value="" type="text">
                               </div>
                               <div class="col-sm-2">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <div class="row">
                               <div class="col-sm-8">
                                   <input id="CPU" class=" form-control col-md-7 col-xs-12" name="cpu" value="" type="text">
                               </div>
                               <div class="col-sm-2">
                                <p id="icon-CPU"></p>
                               </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <div class="row">
                               <div class="col-sm-8">
                                   <input type="text" id="Ram" name="ram" class="form-control col-md-7 col-xs-12" value="">
                               </div>
                               <div class="col-sm-2">
                                <p id="icon-Ram"></p>
                               </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <div class="row">
                               <div class="col-sm-8">
                                   <input id="boNhoTrong" class=" form-control col-md-7 col-xs-12" name="boNhoTrong" value="" type="text">
                               </div>
                               <div class="col-sm-2">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <div class="row">
                               <div class="col-sm-8">
                                    <input id="theNho" class=" form-control col-md-7 col-xs-12" name="theNho" value="" type="text">
                               </div>
                               <div class="col-sm-2">
                                <p id="icon-theNho"></p>
                               </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <div class="row">
                               <div class="col-sm-8">
                                   <input id="ketNoiMang" class=" form-control col-md-7 col-xs-12" name="ketnoimang" value="" type="text">
                               </div>
                               <div class="col-sm-2">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <div class="row">
                               <div class="col-sm-8">
                                   <input id="theSim" class=" form-control col-md-7 col-xs-12" name="theSim" value="" type="text">
                               </div>
                               <div class="col-sm-2">
                                <p id="icon-theSim"></p>
                               </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <div class="row">
                               <div class="col-sm-8">
                                  <input id="Wifi" class=" form-control col-md-7 col-xs-12" name="wifi" value="" type="text">
                               </div>
                               <div class="col-sm-2">
                                <p id="icon-Wifi"></p>
                               </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <div class="row">
                               <div class="col-sm-8">
                                   <input id="GPS" class=" form-control col-md-7 col-xs-12" name="gps" value="" type="text">
                               </div>
                               <div class="col-sm-2">
                                <p id="icon-GPS"></p>
                               </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <div class="row">
                               <div class="col-sm-8">
                                   <input id="ChatLieuSanPham" class=" form-control col-md-7 col-xs-12" name="chatlieu" value="" type="text">
                               </div>
                               <div class="col-sm-2">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <div class="row">
                               <div class="col-sm-8">
                                    <input id="kichThuoc" class=" form-control col-md-7 col-xs-12" name="kichThuoc" value="" type="text">
                               </div>
                               <div class="col-sm-2">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <div class="row">
                               <div class="col-sm-8">
                                   <input id="trongLuong" class=" form-control col-md-7 col-xs-12" name="trongluong" value="" type="text">
                               </div>
                               <div class="col-sm-2">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <div class="row">
                               <div class="col-sm-8">
                                   <input id="dungLuongPin" class=" form-control col-md-7 col-xs-12" name="pin" value="" type="text">
                               </div>
                               <div class="col-sm-2">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <div class="row">
                               <div class="col-sm-8">
                                   <input id="loaiPin" class=" form-control col-md-7 col-xs-12" name="loaibin" value="" type="text">
                               </div>
                               <div class="col-sm-2">
                                <p id="icon-loaiPin"></p>
                               </div>
                      ...
                      <div class="form-group">
                        <div class="col-md-4 col-sm-4 col-xs-12 col-md-offset-4">
                          <button type="submit" class="btn btn-sm btn-success"><span class="glyphicon glyphicon-plus" aria-hidden="true"> </span>  Thêm sản phẩm</button>
                        </div>
                      </div>
                    </form>
                  </div>
