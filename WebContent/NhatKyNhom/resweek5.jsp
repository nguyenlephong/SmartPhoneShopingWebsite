...
<html lang="en">
<head>
  <title>Kết quả hoàn thành tuần 5</title>
  <meta charset="utf-8">
...
<body>
  ...
  <center><h1 style="color: red;margin-top: 100px">Kết quả hoàn thành nhiệm vụ tuần 5</h1></center>
<div class="khoangcachtrong" id="nth">
  <center><h2><strong>Nguyễn Tấn Hậu</strong></h2>
   <h2><strong>Kết quả:</strong></h2></center>
   <center><img src="../img/chitietsphau5.png" width="" height=""></center>  
   <center><h2>Code hiện thực:</h2>
   <img src="../img/thongtinspcodehau5.png">
   </center>  
 ...
 <div class=" khoangcachtrong" id="nlp">
   <center><strong> <h2>Nguyễn Lê Phong</h2></strong>
     <h2><strong>Kết quả:</strong></h2></center>
     <center>
        <img src="../img/donhang5.png" width="" height="">
        <img src="../img/khohang5.png" width="" height="">
        <img src="../img/khachhang5.png" width="" height="">

     </center>    
     <center><h2>Code hiện thực:</h2>
        <img src="../img/codedonhang5.png" width="" height="">
        <img src="../img/codekhachhang5.png" width="" height="">
     </center>
   </div>
   <div class=" khoangcachtrong" id="dqk">
    <center><h2><strong>Đàm Quang Khoa</strong></h2>
      ...
      <center><img src="../img/hoidap5khoa.png" width="" height=""> </center>  

     </div>
     <div class=" khoangcachtrong" id="hpn">
      <center> <h2><strong>Huỳnh Phước Ngà</strong></h2>
       <h2><strong>Kết quả:</strong></h2></center>
       <center><img src="../img/giaodien.png" width="" height=""></center>    
       <center><h2>Code hiện thực:</h2>
          <img src="../img/indexcode5nga.png">
       </center>
     </div>
