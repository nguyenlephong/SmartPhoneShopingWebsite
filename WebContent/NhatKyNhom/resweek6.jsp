...
<html lang="en">
<head>
  <title>Kết quả hoàn thành tuần 6</title>
  <meta charset="utf-8">
...
<body>
  ...
  <center><h1 style="color: red;margin-top: 100px">Kết quả hoàn thành nhiệm vụ tuần 6</h1></center>
<div class="khoangcachtrong" id="nth">
  <center><h2><strong>Nguyễn Tấn Hậu</strong></h2>
   <h2><strong>Kết quả:</strong></h2></center>
   <center><img src="../img/binhluan6.png" width="" height=""></center>  
   <center><h2>Code hiện thực:</h2>
   <img src="../img/bluancode6.png">
   </center>  
 ...
 <div class=" khoangcachtrong" id="nlp">
   <center><strong> <h2>Nguyễn Lê Phong</h2></strong>
     <h2><strong>Kết quả:</strong></h2></center>
     <center>
        <img src="../img/thongke.png" width="" height="">

     </center>    
     <center><h2>Code hiện thực:</h2>
        <img src="../img/codethongke6.png" width="" height="">
        <img src="../img/codebieudo6.png" width="" height="">
     </center>
   </div>
     ...
     <div class=" khoangcachtrong" id="hpn">
      <center> <h2><strong>Huỳnh Phước Ngà</strong></h2>
       <h2><strong>Kết quả:</strong></h2></center>
       <center><img src="../img/locgiansxnga6.png" width="" height=""></center>    
       <center><h2>Code hiện thực:</h2>
          <img src="../img/loctheonsx6.png">
