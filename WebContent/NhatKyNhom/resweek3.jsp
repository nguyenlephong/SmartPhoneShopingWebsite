...
<html lang="en">
<head>
  <title>Kết quả hoàn thành tuần 3</title>
  <meta charset="utf-8">
...
<body>
  ...
  <center><h1 style="color: red;margin-top: 100px">Kết quả hoàn thành nhiệm vụ tuần 3</h1></center>
<div class="khoangcachtrong" id="nth">
  <center><h2><strong>Nguyễn Tấn Hậu</strong></h2>
   <h2><strong>Kết quả:</strong></h2></center>
   <center><img src="../img/giaodien.png" width="70%" height=""></center>  	
   <center> <h2><strong>Code hiện thực:</strong></h2></center>
   <center><img src="../img/codegiaodien3.png" width="" height="50%"></center>   
 </div>
 <div class=" khoangcachtrong" id="nlp">
   <center><strong> <h2>Nguyễn Lê Phong</h2></strong>
     <h2><strong>Kết quả:</strong></h2></center>
     <center><img src="../img/admin.png" width="70%" height=""></center>    

   </div>
   <div class=" khoangcachtrong" id="dqk">
    <center><h2><strong>Đàm Quang Khoa</strong></h2>
      <h2><strong>Kết quả:</strong></h2>
      <h5>Giao diện hỏi đáp</h5></center>
      <center><img src="../img/hoidap3.png" width="70%" height=""> 
       <h5>Đưa ra tên biểu đồ,dạng biểu đồ,kết nối dữ liệu bản đồ:</h5></center>   
       <center><img src="../img/dangbieudo3.png" width="70%" height=""></center>  

     </div>
     <div class=" khoangcachtrong" id="hpn">
      <center> <h2><strong>Huỳnh Phước Ngà</strong></h2>
       <h2><strong>Kết quả:</strong></h2></center>
       <center><img src="../img/database.png" width="%" height=""></center>    
