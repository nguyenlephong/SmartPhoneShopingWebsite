...
<html lang="en">
<head>
  <title>Kết quả hoàn thành tuần 4</title>
  <meta charset="utf-8">
...
<body>
  ...
  <center><h1 style="color: red;margin-top: 100px">Kết quả hoàn thành nhiệm vụ tuần 4</h1></center>
<div class="khoangcachtrong" id="nth">
  <center><h2><strong>Nguyễn Tấn Hậu</strong></h2>
   <h2><strong>Kết quả:</strong></h2></center>
   <center><img src="../img/hau4database.png" width="70%" height=""></center>    
 ...
 <div class=" khoangcachtrong" id="nlp">
   <center><strong> <h2>Nguyễn Lê Phong</h2></strong>
     <h2><strong>Kết quả:</strong></h2></center>
     <center>
        <img src="../img/binhluan4giaodien.png" width="" height="">
        <img src="../img/dangnhap4giaodien.png" width="" height="">
     </center>    
     <center><h2>Code hiện thực:</h2>
        <img src="../img/binhluan4.png" width="%" height="">
        <img src="../img/codedangnhap4.png" width="" height="">
     </center>
   </div>
   <div class=" khoangcachtrong" id="dqk">
    <center><h2><strong>Đàm Quang Khoa</strong></h2>
      <h2><strong>Kết quả:</strong></h2>
      <h5>Database sản phẩm</h5></center>
      <center><img src="../img/mausanpham4.png" width="70%" height=""> </center>  

     </div>
     <div class=" khoangcachtrong" id="hpn">
      <center> <h2><strong>Huỳnh Phước Ngà</strong></h2>
       <h2><strong>Kết quả:</strong></h2></center>
       <center><img src="../img/thongtinchitietsp.png" width="" height=""></center>    
