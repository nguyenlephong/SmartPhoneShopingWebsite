...
<body>
	...
	<!-- Banner ---> <!-- Product -->
	 <%
	 ArrayList<ThongTinDienThoai>array=(ArrayList)session.getAttribute("timkiem");
		 int sizeDisplay=12;
	 ...
	 %></span>
			...
			<div class="" style="float:left">
				...
				<div class="" style="float:right;">
					<center><a href="XulyGioHang?ttsp=<%out.print(array.get(j).getTen()+"-"+array.get(j).getGia()+"-"+array.get(j).getHinhAnh()+"-"+array.get(j).getMaSP()); %>"><button type="button" class="btn_buynow">Mua ngay</button></a></center>
				</div>
				</li>
			<%
				}
